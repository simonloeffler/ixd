...
if (process.env.DEEPSPEECH_MODEL) {
	...
	DEEPSPEECH_MODEL = __dirname + '/model-german/';
}
...
function createModel(modelDir) {
	...
	let scorerPath = modelDir + 'kenlm_azwtd.scorer';
...
function onRecognize(results) {
	if (results.text === 'quit') {
		...
		var words = results.text.split(' ');
		for (let i = 0; i < words.length; i++) {
			if(words[i] == 'jasper' || words[i] == 'jaspar') {
				console.log('      #    #     #####  ######  ####### ######     ### ###');
				console.log('      #   # #   #     # #     # #       #     #    ### ###');
				console.log('      #  #   #  #       #     # #       #     #    ### ###');
				console.log('      # #     #  #####  ######  #####   ######      #   # ');
			...
			else if(words[i] == 'martin' || words[i] == 'marvin' || words[i] == 'mathe') {
				console.log('#    #   ##   #####  ##### # #    #');
				console.log('##  ##  #  #  #    #   #   # ##   #');
				console.log('# ## # #    # #    #   #   # # #  #');
				console.log('#    # ###### #####    #   # #  # #');
